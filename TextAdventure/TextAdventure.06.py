...
We change TextAdventure.05.py to:

* restore data from a save file, if any
"""
...
def init_default_state():
    """Initialize data if there is no restore file."""
...
def map_instances_ref():
    ...
    global place_name_ref, object_name_ref, monster_name_ref
