...
Usage: Secret_Messages.07.1.py <original image file> <encoded image file>
"""
...
result = []             # place to save each decoded byte
...
def bits_init_tostring(numbits):
    ...
    old_result = bytes(result).decode(encoding='utf_8')
